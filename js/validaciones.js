...
const mensajesDeError = {                                   // mejor organizacion de codigo
    ...
    password: {
        ...
        patternMismatch: "6 caracteres, máximo 12, una letra minúscula, una letra mayúscula, un número y no puede contener caracteres especiales."
    },
    nacimiento: {
...
export {valida};                                      // se exporta para poderlo usar en otros lugares del codigo
